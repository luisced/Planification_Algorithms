...
struct Proceso {
    ...
    rafaga: u32,
    // Estos campos se incluyen solo si vas a deserializarlos del Excel
    // Si no los usas en tu algoritmo FCFS, puedes omitirlos
    #[serde(rename = "Quantum")]
    quantum: Option<u32>, // Omitible si no se usa en FCFS
    #[serde(rename = "Prioridad")]
    prioridad: Option<u32>, // Omitible si no se usa en FCFS
}
#[derive(Debug)]
